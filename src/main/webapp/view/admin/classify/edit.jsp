          ...
          <div class="row">
            ...
            <div class="col-xl-12 col-lg-12">
              <div class="card shadow mb-4">
                ...
                <div class="card-body">
                 <div class="container">
					  <form action="<%=request.getContextPath() + "/admin-classify-edit" %>" method="POST" class="needs-validation" novalidate>
				    ...
				    <input type = "hidden" value="<%= (classify != null ? classify.getId() : "") %>" name="id">
				   <div class="row">
