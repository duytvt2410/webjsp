					...
					<div class="col-md-5 col-md-push-2">
						...
						<% for(ImagesModel images : product.getImagesDetail()){  %>
							<div class="product-preview">
								<img src="data:image/jpg;base64,<%= images.getBase64Image()%>" alt="">
							</div>
						<%} %>
						</div>
					</div>
					...
					<div class="col-md-5">
						<div class="product-details">
							...
							<div>
								...
								<a class="review-link" href="#">10 đánh giá | Thêm nhận xét của bạn</a>
							</div>
							<div>
					...
					<div class="col-md-3 col-xs-6">
						<div class="product">
							<div class="product-img">
								<img src="data:image/jpg;base64,<%= productRelated.getImageProduct().getBase64Image()%>" alt="">
							...
							<div class="product-body">
								...
								<h3 class="product-name"><a href="<%= request.getContextPath() + "/chitietsp?tensp=" + productRelated.getAlias()%>"><%= productRelated.getName() %></a></h3>
